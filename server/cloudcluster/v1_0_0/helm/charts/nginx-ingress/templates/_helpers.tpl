...
{{- default (include "nginx-ingress.name" .) .Values.config.name -}}
{{- end -}}
...
{{- default (include "nginx-ingress.name" .) .Values.service.name }}
{{- end -}}
...
{{- default (include "nginx-ingress.name" .) .Values.name -}}
{{- end -}}