...
urlpatterns = [
   ...
   path('oauth/azure/getgrantauthurladminconsent', views.oauth_azure_get_grant_auth_url_admin_consent),
   ...
   path('azuregrantadminconsent', views.oauth_azure_grantadminconsent),
