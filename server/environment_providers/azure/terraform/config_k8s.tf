...
#   gallery_image_reference_id = "/subscriptions/af5bb549-d639-4ea4-9632-5b6aa6881cd8/resourceGroups/Packer/providers/Microsoft.Compute/galleries/Packer_image_gallery/images/dlcm-ubuntu-1804/versions/1.0.0"
# }
...
resource "null_resource" "azure_instances_exec" {
  depends_on = [azurerm_virtual_machine_data_disk_attachment.longhorn]
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo chown -R ${var.azure_user}:${var.azure_user} /var/lib/longhorn",
      "sudo chmod 777 /var/lib/longhorn",
      "sudo mkfs -t ext4 /dev/disk/azure/scsi1/lun1",
      "sudo echo '/dev/disk/azure/scsi1/lun1 /var/lib/longhorn ext4 defaults 0 0' | sudo tee -a /etc/fstab",
      "sudo mount -a",
    ]
  }
}
